layui.config({
	...
	//用户数
	$.get("../script/json/usersList.json",
		function(data){
	...
	if(window.sessionStorage.getItem("systemParameter")){
		...
		$.ajax({
			url : "../script/json/systemParameter.json",
			type : "get",
			dataType : "json",
